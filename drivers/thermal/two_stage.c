 ...
 *
 *  Based on drivers/thermal/step_wise.c - A step-by-step Thermal throttling governor
 *
...
static void thermal_zone_trip_update(struct thermal_zone_device *tz, int trip)
{
	...
	dev_dbg(&tz->device, "Trip%d[type=%d,temp=%ld],throttle=%d\n",
...
{
	return thermal_register_governor(&thermal_gov_two_stage);
}

void thermal_gov_two_stage_unregister(void)
{
	thermal_unregister_governor(&thermal_gov_two_stage);
}
